...
import rz.mesabrook.wbtc.client.category.AbstractCategory;
import rz.mesabrook.wbtc.client.category.Categories;
...
public class CreativeGuiDrawHandler 
{
    ...
    public void onDrawGui(InitGuiEvent.Post event)
    {
    	...
    	if(event.getGui() instanceof GuiContainerCreative)
    	{
            ...
            this.categories = new AbstractCategory[] {Categories.BUILDING_BLOCKS, Categories.CEILING_BLOCKS, Categories.HOUSEHOLD, Categories.TOOLS, Categories.RAW, Categories.MUSIC, Categories.TROPHY};
