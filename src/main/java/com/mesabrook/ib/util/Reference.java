...
public class Reference
{
	...
	public static final String UPDATE_NAME = "The Technology Update - Pre-Release 2";
	public static final String VERSION = "1.0.0-PR2";
	public static final String BUILD_DATE = "Sometime in 2022";
	public static final String CHANGELOG = "https://bit.ly/3zxMSZm";
	...
	public static final int MAX_RINGTONES = 1; // This is an INCLUSIVE number
