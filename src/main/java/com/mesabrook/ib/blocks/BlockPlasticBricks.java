...
public class BlockPlasticBricks extends Block implements IHasModel
{
	public static PropertyEnum<EnumDyeColor> COLOR = PropertyEnum.create("color", EnumDyeColor.class);
	public BlockPlasticBricks()
	{
        super(Material.ROCK);
        setUnlocalizedName("plastic_bricks");
        setRegistryName("plastic_bricks");
        setHardness(1.5F);
        setResistance(8.0F);
        ...
        ModItems.ITEMS.add(new ItemBlock(this)
        {
            ...
            {
                return "tile.plastic_bricks." + EnumDyeColor.byMetadata(stack.getMetadata()).getName();
            }
