...
public class BlockColoredCobblestone extends Block implements IHasModel {
    ...
    public BlockColoredCobblestone() {
        ...
        ModItems.ITEMS.add(new ItemBlock(this)
        {
            ...
            {
                return "tile.colored_cobblestone." + EnumDyeColor.byMetadata(stack.getMetadata()).getName();
            }
