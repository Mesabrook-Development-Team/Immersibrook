...
public class GuiSettingsAboutPhone extends GuiPhoneBase {
	...
	public void initGui() {
		...
		factoryReset = new MinedroidButton(1, INNER_X + 3, INNER_Y + 50, INNER_TEX_WIDTH - 6, "Factory Reset", 0xFFFFFF);
	...
	protected void doDraw(int mouseX, int mouseY, float partialticks) {
		...
		fontRenderer.drawString("Phone Number:", INNER_X + 3, INNER_Y + 36, 0x4444FF);
		int stringWidth = fontRenderer.getStringWidth("Phone Number:");
		fontRenderer.drawString(getFormattedPhoneNumber(phoneStackData.getPhoneNumberString()), INNER_X + 3 + stringWidth + 3, INNER_Y + 36, 0xFFFFFF);
