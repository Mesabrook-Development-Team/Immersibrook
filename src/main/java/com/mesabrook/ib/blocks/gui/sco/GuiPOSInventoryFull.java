...
public class GuiPOSInventoryFull extends GuiPOSBase {

	private GuiImageLabelButton adminMode;
	public GuiPOSInventoryFull(TileEntityRegister register) {
		super(register);
	}
	...
	protected void doDraw(int mouseX, int mouseY, float partialTicks) {
		...
		fontRenderer.drawString(TextFormatting.ITALIC + "Inventory Full", (int)((innerLeft + innerWidth / 2) * (1/scale)) - (fontRenderer.getStringWidth(TextFormatting.ITALIC + "Inventory Full") / 2), (int)((innerTop + innerHeight / 2) * (1/scale)) - fontRenderer.FONT_HEIGHT, 0);
